...
import { v4 as uuidv4 } from 'uuid'; // For generating unique SKU-ID
...
const ProductAdd = () => {
    ...
    const handleSelectCategory = (category:any) => {
      ...
      setSearchQuery(category.name); // Set the input value to the selected category name
    ...
    const handleAddProduct = async () => {
      ...
      const skuId = `SKU-${uuidv4().slice(0, 8).toUpperCase()}`; // Generate unique SKU-ID
